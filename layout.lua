...
local function AddHeader()
  ...
  table.insert(graphics,{Type = "Image", Image = DechenLogo, Position = {22,22}, Size = {140,35}})
  table.insert(graphics,{Type = "Image", Image = EFcMufiQ8GwkDct4nPpQmcLogo, Position = {318,22}, Size = {146,39}})
  AddText("Cue Stack Controller", 42, 62, 100, 16, 8)
  AddText("IP ADDRESS", 20, 88, 92, 12, 8, "Left")
  AddText("PORT", 124, 88, 30, 12, 8, "Left")
  AddText("STATUS", 162, 88, 108, 12, 8, "Left")
  AddTextControl("IPAddress", 22, 103, 96, 21, "Text")
  AddTextControl("TCPPort", 124, 103, 30, 21, "Text")
  AddTextControl("StatusText", 162, 103, 108, 21, "Textdisplay")
  AddLed("ConnectionActive", 400, 106, Green)
  AddText("TCP", 421, 105, 34, 16, 8, "Left")
  layout["ConnectionStatus"] = {PrettyName = "ConnectionStatus", Style = "Status", Position = {282,103}, Size = {104,21}, FontSize = 8}
end
...
local function AddControlPage()
  AddHeader()
  AddGroupBox("CONNECTION / STATUS", 44, 160, 438, 142)
  AddText("SERVER VERSION", 66, 194, 104, 12, 8, "Left")
  AddTextControl("ServerVersion", 66, 216, 116, 23, "Textdisplay")
  AddText("PLAYBACK", 206, 194, 64, 12, 8, "Left")
  AddTextControl("ActivePlayback", 206, 216, 64, 23, "Textdisplay")
  AddText("CUE STACK", 294, 194, 78, 12, 8, "Left")
  AddTextControl("ActiveCueStack", 294, 216, 132, 23, "Textdisplay")
  AddText("CUE", 66, 252, 64, 12, 8, "Left")
  AddTextControl("ActiveCue", 66, 274, 116, 23, "Textdisplay")
  AddText("STATE", 206, 252, 64, 12, 8, "Left")
  AddTextControl("PlaybackState", 206, 274, 220, 23, "Textdisplay")

  AddGroupBox("CUE STACKS / PRESETS", 44, 324, 438, 324)
  AddText("#", 52, 354, 20, 14, 8)
  AddText("NAME", 78, 354, 96, 14, 8, "Left")
  AddText("PB", 180, 354, 34, 14, 8)
  AddText("STACK", 220, 354, 62, 14, 8)
  AddText("COMMAND", 288, 354, 120, 14, 8, "Left")
