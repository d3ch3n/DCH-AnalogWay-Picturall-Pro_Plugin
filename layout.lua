...
local function AddControlPage()
  AddHeader()
  AddGroupBox("CONNECTION / STATUS", 44, 160, 438, 118)
  AddText("SERVER VERSION", 66, 194, 104, 12, 8, "Left")
  AddTextControl("ServerVersion", 66, 210, 116, 23, "Textdisplay")
  AddText("PLAYBACK", 206, 194, 64, 12, 8, "Left")
  AddTextControl("ActivePlayback", 206, 210, 64, 23, "Textdisplay")
  AddText("CUE STACK", 294, 194, 78, 12, 8, "Left")
  AddTextControl("ActiveCueStack", 294, 210, 132, 23, "Textdisplay")
  AddText("CUE", 66, 240, 64, 12, 8, "Left")
  AddTextControl("ActiveCue", 66, 254, 116, 23, "Textdisplay")
  AddText("STATE", 206, 240, 64, 12, 8, "Left")
  AddTextControl("PlaybackState", 206, 254, 220, 23, "Textdisplay")

  AddGroupBox("CUE STACKS / PRESETS", 44, 300, 438, 348)
  AddText("#", 52, 330, 20, 14, 8)
  AddText("NAME", 78, 330, 96, 14, 8, "Left")
  AddText("PB", 180, 330, 34, 14, 8)
  AddText("STACK", 220, 330, 62, 14, 8)
  AddText("COMMAND", 288, 330, 120, 14, 8, "Left")
