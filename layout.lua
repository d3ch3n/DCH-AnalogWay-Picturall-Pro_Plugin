...
local function AddHeader()
  ...
  table.insert(graphics,{Type = "Image", Image = EFcMufiQ8GwkDct4nPpQmcLogo, Position = {350,22}, Size = {146,39}})
  ...
  layout["ConnectionStatus"] = {PrettyName = "ConnectionStatus", Style = "Status", Position = {162,103}, Size = {224,21}, FontSize = 8}
