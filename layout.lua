...
local function AddHeader()
  ...
  table.insert(graphics,{Type = "Image", Image = EFcMufiQ8GwkDct4nPpQmcLogo, Position = {246,18}, Size = {226,64}})
  AddText("Cue Stack Controller", 42, 62, 100, 16, 8)
  AddText("IP ADDRESS", 20, 86, 92, 14, 8, "Left")
  AddText("PORT", 118, 86, 30, 14, 8, "Left")
  AddText("STATUS", 150, 86, 108, 14, 8, "Left")
  AddTextControl("IPAddress", 22, 102, 92, 22, "Text")
  AddTextControl("TCPPort", 118, 102, 28, 22, "Text")
  AddTextControl("StatusText", 150, 102, 110, 22, "Textdisplay")
  AddLed("ConnectionActive", 385, 105, Green)
  AddText("TCP", 406, 104, 34, 16, 8, "Left")
  layout["ConnectionStatus"] = {PrettyName = "ConnectionStatus", Style = "Status", Position = {270,102}, Size = {102,22}, FontSize = 8}
end
